...
public class ProjectController {
    ...
    public List<ProjectDto> getAllProjects(Authentication authentication) {
        return projectService.getAllProjects(userService.getUserFromAuthentication(authentication).getId());
    }
    ...
    public ProjectDto getProjectDetails(Authentication authentication, @PathVariable Long id) {
        return projectService.getProjectDetails(userService.getUserFromAuthentication(authentication).getId(),
                id);
    }
    ...
    public void deleteProject(Authentication authentication, @PathVariable Long id) {
        projectService.deleteProject(userService.getUserFromAuthentication(authentication).getId(), id);
    }
}
